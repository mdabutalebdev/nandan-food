...
import { UPLOAD_DIR } from './app/utils/cloudinary';
...
// Trust reverse proxy (e.g. Coolify/Traefik) so req.protocol correctly reports 'https'
...
app.get('/', (req: Request, res: Response) => {
    res.status(200).json({
        success: true,
        message: '🛒 Fresh Food Bazar API Server is running!',
        version: '1.0.0',
