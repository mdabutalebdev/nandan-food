...
const SiteContentController = {
    ...
    updateSection: catchAsync(async (req: Request, res: Response) => {
        ...
        // `contact.socials` is a dotted path so the Social Links page can save
        // just the social list without resending the rest of the contact block.
        const validSections = ['ticker', 'contact', 'contact.socials', 'floating', 'footer', 'defaultTagline', 'seo', 'announcement', 'legalPages', 'homeSections', 'navMenu', 'topSelling', 'heroSlides', 'heroSideBanners', 'healthPromises', 'productShowcase', 'outlets', 'outletList', 'exportBrochure', 'careers', 'aboutIntro', 'aboutMission', 'aboutVision', 'ownerMessage', 'management', 'clients', 'certifications'];
    ...
    getLegalPage: catchAsync(async (req: Request, res: Response) => {
        ...
        const validSlugs = ['terms', 'privacy', 'refund', 'about', 'faq'];
